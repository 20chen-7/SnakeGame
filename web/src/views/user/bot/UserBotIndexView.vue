                        ...
                        <div class="modal fade" id="add-bot-btn" tabindex="-1">
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="add-bot-title" class="form-label">Username</label>
                                        <input v-model="botadd.title" type="text" class="form-control" id="add-bot-title" placeholder="Please enter Username">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="add-bot-description" class="form-label">Abstract</label>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" @click="update_bot(bot)" data-bs-dismiss="modal">Save</button>
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                </div>
                                                </div>
                                            </div>
